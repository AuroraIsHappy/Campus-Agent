...
import {
  DashboardPage, OnboardingPage, DemoBPage, DemoCenterPage, KanbanPage, PersonaPage, MemoryPage, LifePage, ResearchPage,
} from "./pages";

type View = "dashboard" | "onboarding" | "demo" | "demob" | "research" | "kanban" | "persona" | "memory" | "life";
